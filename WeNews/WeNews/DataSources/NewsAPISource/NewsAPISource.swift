...
class NewsAPISource {
    ...
    func sendGetTopHeadlines(withKeywords keywords: String, forPage page: Int) -> Observable<News> {
        ...
        request.url = .init(string: self.baseURL + "/top-headlines?q=\(keywords)&searchIn=title,content&sortBy=relevancy&page=\(page)")
